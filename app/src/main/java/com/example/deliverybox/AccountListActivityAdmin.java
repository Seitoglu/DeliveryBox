...
import com.example.deliverybox.Adapter.AccountAdapterAdmin;
...
public class AccountListActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_list_admin);
        recyclerView = findViewById(R.id.accountList_recyclerView_admin);

        backBtn = findViewById(R.id.bckBtn2);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (account_type){
                    case 1:
                        Intent intent = new Intent(AccountListActivityAdmin.this, AdminActivity.class);
                    ...
                    case 2:
                        Intent intent1 = new Intent(AccountListActivityAdmin.this, EmployeeActivity.class);
                    ...
                    case 3:
                        Intent intent2 = new Intent(AccountListActivityAdmin.this, WelcomeActivity.class);
                        ...
                        break;
                    default:
                        Toast.makeText(AccountListActivityAdmin.this, "Error!", Toast.LENGTH_LONG).show();
                        break;
                }
            }
        });
    ...
    private void loadAccounts() {
        ...
        accountApi.getAllAccounts().enqueue(new Callback<List<Account>>() {
            ...
            public void onFailure(Call<List<Account>> call, Throwable throwable) {
                Toast.makeText(AccountListActivityAdmin.this, "Failed to load accounts", Toast.LENGTH_SHORT).show();
    ...
    private void populateListView( List<Account> accountList) {
        AccountAdapterAdmin accountAdapterAdmin = new AccountAdapterAdmin( accountList);
        recyclerView.setAdapter(accountAdapterAdmin);
